...
void ItemTab::confirm() {
  ...
  case 0: {
    ...
    listItem.push_front(
        new Book(id, title, isLent, authorBook, pageNumberBook, genreBook));
    Book *provo =
        new Book(id, title, isLent, authorBook, pageNumberBook, genreBook);
    provo->print();
    break;
  ...
  case 1: {
    ...
    listItem.push_front(new BookSerie(id, title, isLent, authorBookSerie,
                                      pageNumber, genreBookSerie, volume));
    break;
  }
  case 2: {
    ...
    listItem.push_front(
        new Film(id, title, isLent, director, duration, genreFilm));
    break;
  }
  case 3: {
    ...
    listItem.push_front(
        new BoardGame(id, title, isLent, genreBoardGame, playerNumber));
    break;
  }
  case 4: {
